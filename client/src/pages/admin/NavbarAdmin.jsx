...
const NavbarAdmin = () => {
  ...
  // Ajoutez cette fonction dans votre composant NavbarAdmin
...
*/}
{/* Desktop Search Bar - Modifiez cette partie */}
<div className="relative mx-4">
...
{/* Mobile Search Bar - Modifiez cette partie 
<div className="relative mb-6">
  <form onSubmit={handleSearch}>
    <HiSearch className="absolute left-3 top-3 text-gray-500" />
    <input
      type="text"
      placeholder="Rechercher clients, emails, codes dossier..."
              ...
              <AnimatePresence>
                {showNotifDropdown && (
                  ...
                  >
                    ...
                    {/* Add this near your notification icon */}
                                ...
                                <div className="flex items-start">
                                  ...
                                  <div className="w-full">
                                    <div className="font-medium">
                                      {notif.message} {/* Affiche directement le message */}
                                    </div>
